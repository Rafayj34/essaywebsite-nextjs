  ...
  return (
    <div className="mb-5 p-2 ">
      <div className="my-9 flex flex-col items-center  justify-center">
        <h1 className="text-4xl p-1 md:text-2xl border-b-2 border-r-2 shadow-lg border-r-orange-600 border-orange-600 font-bold"><span className='text-slate-800'>Why choose</span><span className='text-orange-600'>&nbsp;us?</span></h1>
