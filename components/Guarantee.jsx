  ...
  return (
    <div className="mb-5 p-2 container mx-auto">
      <div className="my-9 container mx-auto max-w-5xl">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl text-center  p-1 md:text-2xl border-b-2 border-r-2 shadow-lg border-r-orange-600 border-orange-600 font-bold"><span className="text-slate-800">Why choose</span><span className="text-orange-600">&nbsp;us?</span></h2>
