...
<div className="mx-8 sm:mx-16 mt-10 p-3  grid lg:grid-cols-3  grid-cols-1 gap-10 ">
  ...
  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mt-4 border-b-4 border-orange-400 border-l-2 shadow-lg border-l-orange-400 mb-4 p-1">
    How we managed to have such <span className="text-orange-400">nice numbers?</span>
  </h2>
